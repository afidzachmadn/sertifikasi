...
############################################################################################################-->
    ...
    <!--My pegawai-lapangan Custom CSS -->
    ...
    <div id="wrapper">
        ...
        <div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <!-- yield sidebar -->
                    @yield('sidebar-dashboard-pegawai-lapangan')
                    @yield('sidebar-iso-pegawai-lapangan')
                    @yield('sidebar-sni-pegawai-lapangan')
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                @yield('breadcrumb-dashboard-pegawai-lapangan')
                @yield('breadcrumb-iso-pegawai-lapangan')
                @yield('breadcrumb-sni-pegawai-lapangan')
                @yield('breadcrumb-belum-terverifikasi-iso-pegawai-lapangan')
                @yield('breadcrumb-terverifikasi-iso-pegawai-lapangan')
                @yield('breadcrumb-belum-terverifikasi-pembayaran-iso-pegawai-lapangan')
                @yield('breadcrumb-terverifikasi-pembayaran-iso-pegawai-lapangan')
                @yield('breadcrumb-upload-hasil-sertifikasi-iso-pegawai-lapangan')
                @yield('breadcrumb-pilih-pegawai-inspeksi-iso-pegawai-lapangan')
                @yield('breadcrumb-riwayat-pegawai-inspeksi-iso-pegawai-lapangan')
                
                @yield('breadcrumb-belum-terverifikasi-sni-pegawai-lapangan')
                @yield('breadcrumb-belum-terverifikasi-pembayaran-sni-pegawai-lapangan')
                @yield('breadcrumb-terverifikasi-pembayaran-sni-pegawai-lapangan')
                @yield('breadcrumb-upload-hasil-sertifikasi-sni-pegawai-lapangan')
                @yield('breadcrumb-terverifikasi-sni-pegawai-lapangan')
                  

                <!-- contents start here -->
                @yield('header-dashboard-pegawai-lapangan')
                ...
                <div class="row">
                     ...
                     @yield('isi-dashboard-pegawai-lapangan')
                     @yield('isi-iso-pegawai-lapangan')
                     @yield('isi-sni-pegawai-lapangan')

                     @yield('isi-belum-terverifikasi-iso-pegawai-lapangan')
                     @yield('isi-terverifikasi-iso-pegawai-lapangan')
                     @yield('isi-belum-terverifikasi-pembayaran-iso-pegawai-lapangan')
                     @yield('isi-terverifikasi-pembayaran-iso-pegawai-lapangan')
                     @yield("isi-upload-hasil-sertifikasi-iso-pegawai-lapangan")
                     @yield("isi-pilih-pegawai-inspeksi-iso-pegawai-lapangan")
                     @yield("isi-riwayat-pegawai-inspeksi-iso-pegawai-lapangan")

                     @yield('isi-belum-terverifikasi-sni-pegawai-lapangan')
                     @yield('isi-belum-terverifikasi-pembayaran-sni-pegawai-lapangan')
                     @yield('isi-terverifikasi-pembayaran-sni-pegawai-lapangan')
                     @yield("isi-upload-hasil-sertifikasi-sni-pegawai-lapangan")
                     @yield('isi-terverifikasi-sni-pegawai-lapangan')
