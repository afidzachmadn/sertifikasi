...
@section ('breadcrumb-belum-terverifikasi-pembayaran-sni-admin')
 <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> 
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Belum Terverifikasi Pembayaran SNI</li>
                        </ol>
                    </div>
                    <!-- /.breadcrumb -->
                </div>
...
@section("isi-belum-terverifikasi-pembayaran-sni-admin")
    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title">List pendaftar sni yang belum dikonfirmasi pembayarannya</h3>
                                    ...
                                    <tbody>
                                        @foreach($userList as $user)
                                            <tr>
                                                ...
                                                <td>{{$user->email}}</td>
                                                <td>
                                                    <a href="{{env('APP_URL')}}/storage/hasil-upload/img/bukti-pembayaran/sni/{{$user->file_upload_bukti_pembayaran_SNI ? $user->file_upload_bukti_pembayaran_SNI : '#'}}" target="_blank">Lihat</a>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="exampleModalLabel1">Konfirmasi Pembayaran Vertifikasi sni</h4> </div>
                                        <div class="modal-body">
                                            <form action="{{url('konfirmasi-pembayaran-sni-proses')}}" method="post" enctype="multipart/form-data">
                                             {{csrf_field()}}
