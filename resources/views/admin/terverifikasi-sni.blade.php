...
@section ('breadcrumb-terverifikasi-sni-admin')
 <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> 
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Terverifikasi sni</li>
                        </ol>
                    </div>
                    <!-- /.breadcrumb -->
                </div>
...
@section("isi-terverifikasi-sni-admin")
    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title">List pendaftar yang sudah Terverifikasi pengajuan sertifikasi SNI-nya</h3>
                            <p class="text-muted">Untuk membatalkan verifikasi, klik tombol &nbsp<span><button type="button" class="btn btn-success">Terverifikasi</button></span> &nbsp yang ada di kolom <code>Status Sertifikasi SNI</code> dan ikuti instruksi yang muncul.
                            </br>
                                    ...
                                    <tbody>
                                        @foreach($userList as $user)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{env('APP_URL')}}/storage/hasil-upload/pdf/sni/hasil-terbit-sertifikat/{{$user->surat_pengesahan_SNI ? $user->surat_pengesahan_SNI : '#'}}" target="_blank">Lihat</a>
                                                </td>
                                                <td>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="exampleModalLabel1">Konfirmasi Pembatalan Verifikasi sni</h4> </div>
                                        <div class="modal-body">
                                            <form action="{{url('verifikasi-batal-sni-proses')}}" method="post" enctype="multipart/form-data">
                                             {{csrf_field()}}
