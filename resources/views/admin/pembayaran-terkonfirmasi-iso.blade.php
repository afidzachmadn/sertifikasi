...
@section ('breadcrumb-terverifikasi-pembayaran-iso-admin')
 <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> 
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Terverifikasi Pembayaran ISO</li>
                        </ol>
                    </div>
                    <!-- /.breadcrumb -->
                </div>
...
@section("isi-terverifikasi-pembayaran-iso-admin")
    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title">List pendaftar ISO yang sudah dikonfirmasi pembayarannya</h3>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="exampleModalLabel1">Konfirmasi Pembatalan Pembayaran ISO</h4> </div>
                                        <div class="modal-body">
                                            <form action="{{url('konfirmasi-pembatalan-pembayaran-iso-proses')}}" method="post" enctype="multipart/form-data">
                                             {{csrf_field()}}
