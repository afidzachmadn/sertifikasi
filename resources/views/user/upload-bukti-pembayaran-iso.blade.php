                ...
                <div class="col-sm-12">
                    <form action="{{url('/user/upload-bukti-pembayaran-iso-proses')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="white-box" class="col-sm-12 col-md-2 col-xs-12 col-lg-12">
                            ...
                            <input type="file" id="input-file-max-fs" class="dropify" data-max-file-size="2M" data-allowed-file-extensions="jpg" name="pdf-bukti-pembayaran-iso" data-default-file="{{env('APP_URL')}}/storage/hasil-upload/img/bukti-pembayaran/iso/{{$iso_pembayaran_p->file_upload_bukti_pembayaran_ISO}}" value="{{env('APP_URL')}}/storage/hasil-upload/img/bukti-pembayaran/iso/{{$iso_pembayaran_p->file_upload_bukti_pembayaran_ISO}}" required=""/> 
                        </div>
