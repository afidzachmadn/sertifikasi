...
<div class="col-sm-12">
                    <form action="{{url('sni-proses')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="white-box">
                            ...
                            <input type="file" id="input-file-max-fs" class="dropify" data-max-file-size="2M" data-allowed-file-extensions="pdf" name="pdf-sni-1" data-default-file="{{env('APP_URL')}}/storage/hasil-upload/pdf/sni/hasil-terbit-sertifikat/{{$sni_p->file_upload_sni_1}}" value="{{env('APP_URL')}}/storage/hasil-upload/pdf/sni/hasil-terbit-sertifikat/{{$sni_p->file_upload_sni_1}}" required=""/> 
                        </div>
                        ...
                        <div class="white-box">
                            ...
                            <input type="file" id="input-file-disable-remove" class="dropify" data-max-file-size="2M" data-allowed-file-extensions="pdf" name="pdf-sni-2" data-default-file="{{env('APP_URL')}}/storage/hasil-upload/pdf/sni/hasil-terbit-sertifikat/{{$sni_p->file_upload_sni_2}}" value="{{env('APP_URL')}}/storage/hasil-upload/pdf/sni/hasil-terbit-sertifikat/{{$sni_p->file_upload_sni_2}}" required=""/> </div>
                        ...
                        <div class="white-box">
                            ...
                            <input type="file" id="input-file-disable-remove" class="dropify" data-max-file-size="2M" data-allowed-file-extensions="pdf" name="pdf-sni-3" data-default-file="{{env('APP_URL')}}/storage/hasil-upload/pdf/sni/hasil-terbit-sertifikat/{{$sni_p->file_upload_sni_3}}" value="{{env('APP_URL')}}/storage/hasil-upload/pdf/sni/hasil-terbit-sertifikat/{{$sni_p->file_upload_sni_3}}" required=""/> </div>
                        ...
                        <div class="white-box">
                            ...
                            <input type="file" id="input-file-disable-remove" class="dropify" data-max-file-size="2M" data-allowed-file-extensions="pdf" name="pdf-sni-4" data-default-file="{{env('APP_URL')}}/storage/hasil-upload/pdf/sni/hasil-terbit-sertifikat/{{$sni_p->file_upload_sni_4}}" value="{{env('APP_URL')}}/storage/hasil-upload/pdf/sni/hasil-terbit-sertifikat/{{$sni_p->file_upload_sni_4}}" required=""/> </div>
                        ...
                        <div class="white-box">
                            ...
                            <input type="file" id="input-file-disable-remove" class="dropify" data-max-file-size="2M" data-allowed-file-extensions="pdf" name="pdf-sni-5" data-default-file="{{env('APP_URL')}}/storage/hasil-upload/pdf/sni/hasil-terbit-sertifikat/{{$sni_p->file_upload_sni_5}}" value="{{env('APP_URL')}}/storage/hasil-upload/pdf/sni/hasil-terbit-sertifikat/{{$sni_p->file_upload_sni_5}}" required=""/> </div>
                        ...
                        <div class="white-box">
                            ...
                            <input type="file" id="input-file-disable-remove" class="dropify"  data-max-file-size="2M" data-allowed-file-extensions="pdf" name="pdf-sni-6" data-default-file="{{env('APP_URL')}}/storage/hasil-upload/pdf/sni/hasil-terbit-sertifikat/{{$sni_p->file_upload_sni_6}}" value="{{env('APP_URL')}}/storage/hasil-upload/pdf/sni/hasil-terbit-sertifikat/{{$sni_p->file_upload_sni_6}}" required=""/>
                             </div>
                       ...
                       <br>
                        ...
                        <div class="col-lg-3 col-sm-6 col-xs-12">
                            <a href="{{env('APP_URL')}}/storage/hasil-upload/pdf/sni/hasil-terbit-sertifikat/{{$sni_p->surat_pengesahan_SNI}}" target="_blank">
