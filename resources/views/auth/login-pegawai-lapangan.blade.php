...
<body>
    ...
    <section id="wrapper" class="login-register">
        <div class="login-box login-sidebar" style="opacity:0.8">
            <div class="white-box">
                <form class="form-horizontal form-material" id="loginform" action="{{url('login-proses-pegawai-lapangan')}}" method="post">
                {{ csrf_field() }}
                    <a href="javascript:void(0)" class="text-center db"><img src="{{env('APP_URL')}}/plugins/images/bbtppi.png" alt="Home" />
                        </a>
                    ...
                    <div class="form-group m-b-0">
                        <div class="col-sm-12 text-center">
                            <p class="text-primary m-l-5"><b>Login Khusus Pegwai Lapangan</b></p>
                        </div>
                    </div>
